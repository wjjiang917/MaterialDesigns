 ...
 */
package com.wjjiang.materialdesigns.ui.navigationview;
...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private final int centreContentMargin = (int) getResources().getDimension(R.dimen.fab_margin);
    ...
    public void hideBudgeAtIndex(final int index) {
        if (badgeList.get(index).getVisibility() == GONE) {
            Logger.d("hideBudgeAtIndex... index: " + index + " already hidden");
        } else {
